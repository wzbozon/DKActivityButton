...
{
    self.activityIndicator = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 38, 38)];
    UIImage *image = [UIImage imageNamed:@"preloader"];
    [self.activityIndicator setImage:image];
